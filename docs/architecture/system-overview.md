...
> ⚠️ **SUPERSEDED (2026-07-06).** Срез single-tenant realestate-эры (2026-04-21):
> движок/пайплайн описаны верно, но мультитенантность, auth и деплой с тех пор
> переехали — **истина по текущему состоянию — CLAUDE.md**.
